                            ...
                            <table class="table m-0">
                                ...
                                <tbody>
                                    ...
                                    foreach ($peoples as $key => $onePeople) {
                                        echo 
                                        "<tr>
                                            <th scope='row'>{$onePeople['id']}</th>
                                            <td>{$onePeople['first_name']}</td>
                                            <td>{$onePeople['last_name']}</td>
                                            <td>{$onePeople['user_name']}</td>
                                            <td>
                                                <a href='show.php?id={$onePeople['id']}' class='btn btn-info'>Редактировать</a>
                                                <a href='edit.php?id={$onePeople['id']}' class='btn btn-warning'>Изменить</a>
                                                <a href='delete.php?id={$onePeople['id']}' class='btn btn-danger'>Удалить</a>
                                            </td>
                                        </tr>";
                                    }
                                    ?>
